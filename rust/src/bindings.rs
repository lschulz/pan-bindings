...
pub type PanReplySelInitializeFn =
    ::std::option::Option<unsafe extern "C" fn(local: PanUDPAddr, user: usize)>;
#[doc = " Handles must be deleted by callee."]
...
extern "C" {
    #[doc = "\\brief Close the unix socket **and the PAN connection**.\n\\ingroup adapter"]
